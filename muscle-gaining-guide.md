...
1. [Training: How to Structure Your Workouts](#training-how-to-structure-your-workouts)
2. [Nutrition: Eating to Grow](#nutrition-eating-to-grow)
3. [Recovery: Where Muscle Is Actually Built](#recovery-where-muscle-is-actually-built)
4. [Supplements (What Actually Works)](#supplements-what-actually-works)
...
- Example: 160 lb person => 112–160g protein/day
...
### Carbohydrates
Carbs are your body's preferred energy source. Prioritize **whole grains, rice, oats, potatoes, and fruits**. Eat more carbs on training days.

### Fats
Fats support hormone production (including testosterone). Aim for **0.3–0.5g per pound of body weight** from sources like olive oil, avocado, nuts, and eggs.

### Meal Timing
- Eat **protein at every meal** to maximize muscle protein synthesis.
- A pre-workout meal with **carbs + protein** 1–2 hours before training boosts performance.
- A post-workout meal or shake within **2 hours** after training supports recovery.

### Hydration
- Drink **at least 0.5–1 oz of water per pound of body weight** per day.
- Dehydration reduces strength by up to 10%.
...
- Sleep deprivation elevates cortisol, which **breaks down muscle tissue**.

### Rest Days
- Take **at least 1–2 full rest days** per week.
- "Active recovery" (light walking, mobility, stretching) is fine on rest days.

### Deload Weeks
Every **6–10 weeks**, consider a deload week where you reduce training volume or intensity by ~40–50%. This allows full recovery of joints, tendons, and the nervous system.
...
|------------|---------|------|
| **Creatine Monohydrate** | Increases strength and muscle output | 3–5g/day |
| **Protein Powder** | Convenient protein source | As needed to hit daily protein target |
